...
class AllocationReportValidatorUnitTest extends BaseUnitTest {
    ...
    void setUp() {
        ...
        reportDataBuilder = AllocationReportData.newBuilder().dateFrom(PARAM_DATE_FROM).dateTo(PARAM_DATE_TO).email(PARAM_EMAIL);
    }
    ...
    void testValidateWhenEmailIsMissing() {
        ...
        assertEquals(1, exception.getValidationErrors()
                .getNumberOfErrors());
        assertEquals(new ValidationError(FIELD_EMAIL, FIELD_EMAIL + MISSING), exception.getValidationErrors()
                .getError(0));
    }
    ...
    void testValidateWhenDateFromIsMissing() {
        ...
        assertEquals(1, exception.getValidationErrors()
                .getNumberOfErrors());
        assertEquals(new ValidationError(FIELD_DATE_FROM, FIELD_DATE_FROM + MISSING), exception.getValidationErrors()
                .getError(0));
    }
    ...
    void testValidateWhenDateToIsMissing() {
        ...
        assertEquals(1, exception.getValidationErrors()
                .getNumberOfErrors());
        assertEquals(new ValidationError(FIELD_DATE_TO, FIELD_DATE_TO + MISSING), exception.getValidationErrors()
                .getError(0));
    }
    ...
    void testValidateWhenDatesAreInverted() {
        ...
        assertEquals(1, exception.getValidationErrors()
                .getNumberOfErrors());
        assertEquals(new ValidationError(FIELD_DATE_FROM, FIELD_DATE_FROM + INCONSISTENT), exception.getValidationErrors()
                .getError(0));
    }
    
    @Test
    void testValidateWhenDateToExceedsInterval() {
        var exception = assertThrows(
                InvalidRequestException.class,
        ...
        assertEquals(1, exception.getValidationErrors()
                .getNumberOfErrors());
        assertEquals(new ValidationError(FIELD_DATE_TO, FIELD_DATE_TO + EXCEEDS_INTERVAL), exception.getValidationErrors()
                .getError(0));
    }
