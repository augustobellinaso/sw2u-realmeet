...
import static br.com.sw2u.realmeet.config.properties.EmailConfigProperties.*;
...
public class EmailConfiguration {
    ...
    public JavaMailSender javaMailSender() {
        ...
        mailSender.setPort(Integer.parseInt(emailConfigProperties.getProperty(EmailConfigProperties.PROPERTY_SMTP_PORT)));
